...
public class SilubiumTestNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public SilubiumTestNetParams() {
        super();
        interval = INTERVAL;
    ...
    private static SilubiumTestNetParams instance;
    public static synchronized SilubiumTestNetParams get() {
        if (instance == null) {
            instance = new SilubiumTestNetParams();
        }
        return instance;
    }
