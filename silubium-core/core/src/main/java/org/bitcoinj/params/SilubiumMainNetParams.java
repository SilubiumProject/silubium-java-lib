...
public class SilubiumMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public SilubiumMainNetParams() {
        super();
        interval = INTERVAL;
    ...
    private static SilubiumMainNetParams instance;
    public static synchronized SilubiumMainNetParams get() {
        if (instance == null) {
            instance = new SilubiumMainNetParams();
        }
        return instance;
    }
