...
public abstract class NetworkParameters {
    ...
    public static final String ID_UNITTESTNET = "org.bitcoinj.unittest";
	 /** The string returned by getId() for the Silubium mainnet. */
    public static final String ID_SILUBIUM_MAINNET = "org.bitcoinj.silubium_mainnet";

    /** The string returned by getId() for the Silubium mainnet. */
    public static final String ID_SILUBIUM_TESTNET = "org.bitcoinj.silubium_testnet";
    ...
    public static NetworkParameters fromID(String id) {
        if (id.equals(ID_MAINNET)) {
            ...
            return RegTestParams.get();
        } else if (id.equals(ID_SILUBIUM_MAINNET)) {
            return SilubiumMainNetParams.get();
        } else if (id.equals(ID_SILUBIUM_TESTNET)) {
            return SilubiumTestNetParams.get();
