 ...
 */
@Data
public class DASHNetworkParameters extends NetworkParameters{

    /**
     * base58Prefixes[PUBKEY_ADDRESS]
     */
    private int MAIN_NET_ADDRESS_SUFFIX = 0x4c;
    private int TEST_NET_ADDRESS_SUFFIX = 0x8c;

    /**
     *base58Prefixes[SECRET_KEY]
     */
    private int MAIN_NET_PRIVATE_KEY_PREFIX = 0xcc;
