...
public class BitCoinECKeyPair extends ECKeyPair {
    ...
    public static BitCoinECKeyPair parse(Key keyPair, boolean testNet,NetworkParameters networkParameters) {
        return new BitCoinECKeyPair(keyPair, testNet,networkParameters);
    }

    public static BitCoinECKeyPair parseWIF(String wif,NetworkParameters networkParameters) throws ValidationException {
    ...
    public BitCoinECKeyPair(Key keyPair, boolean testNet,NetworkParameters networkParameters) {
        super(keyPair);
        this.testNet = testNet;
