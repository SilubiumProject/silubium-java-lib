...
//    private static final int SCRYPT_P = 1;
     ...
     */
    public static String encryptNoEcMultiply(CharSequence passphrase, String base58EncodedPrivateKey, NetworkParameters networkParameters) throws ValidationException, InterruptedException {
        ...
        if (version == networkParameters.getTEST_NET_PRIVATE_KEY_PREFIX()) {
            testNet = true;
        } else if (version == networkParameters.getMAIN_NET_PRIVATE_KEY_PREFIX()) {
            testNet = false;
        }
